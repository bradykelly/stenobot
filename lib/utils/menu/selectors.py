# From Solaris: https://github.com/parafoxia/Solaris/blob/master/solaris/utils/menu/selectors.py
...
class Selector:
    ...
    async def response(self):
        ...
        try:
            reaction, user = await self.menu.bot.wait_for_("reaction_add", timeout=self.timeout, check=self.check)
        except TimeoutError:
