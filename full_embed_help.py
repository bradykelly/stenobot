...
class EmbedHelpCommand(commands.HelpCommand):
    ...
    def get_command_signature(self, command):
        ...
        return '{0.name}'.format(command)

    async def send_bot_help(self, mapping):
        embed = discord.Embed(title=f'{common.BOT_NAME} Commands', colour=self.COLOUR)
    ...
    # This makes it so it uses the function above. Less work for us to do since they're both similar.
